...
( cd ${CZMQ_ROOT}/bindings/jna && TERM=dumb $CI_TIME ./gradlew publishToMavenLocal ${GRADLEW_OPTS[@]} ${CZMQ_GRADLEW_OPTS} )
...
#   Build Jar for JVM
TERM=dumb $CI_TIME ./gradlew jvmJar ${GRADLEW_OPTS[@]} ${ZYRE_GRADLEW_OPTS} $IS_RELEASE

#   Build Aar for Android
TERM=dumb $CI_TIME ./gradlew assemble ${GRADLEW_OPTS[@]} ${ZYRE_GRADLEW_OPTS} $IS_RELEASE
